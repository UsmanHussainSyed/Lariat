<template>
  <client-only>
    <speech-recognition v-slot="{ started, start, stop }" v-model="annotation">
      <div class="dropdown common-dropdown top-right-fix-btn annotation">
        <a
          class="dropdown-toggle btn btn-icon"
